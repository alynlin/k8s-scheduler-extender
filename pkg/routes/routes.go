...
func PredicateRoute(predicate *scheduler.Predicate) httprouter.Handle {
	return func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		...
		if err := json.NewDecoder(body).Decode(&extenderArgs); err != nil {
			...
			log.Printf("debug: singleappfilter ExtenderArgs =%v", extenderArgs)
...
func BindRoute(bind *scheduler.Bind) httprouter.Handle {
	return func(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
		...
		if err := json.NewDecoder(body).Decode(&extenderBindingArgs); err != nil {
			...
			log.Printf("debug: singleappBind ExtenderArgs =%v", extenderBindingArgs)
